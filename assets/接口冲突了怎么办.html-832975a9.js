import{_ as n,W as a,X as s,a1 as e}from"./framework-a045178c.js";const t={},i=e(`<h1 id="接口冲突了怎么办" tabindex="-1"><a class="header-anchor" href="#接口冲突了怎么办" aria-hidden="true">#</a> 接口冲突了怎么办？</h1><p>在启动项目的过程中经常会发生接口冲突的问题，那么遇到这种问题应该如何解决呢？下面讨论在Windows系统下出现接口冲突的解决方案。</p><h2 id="windows下端口被占用解决方案" tabindex="-1"><a class="header-anchor" href="#windows下端口被占用解决方案" aria-hidden="true">#</a> Windows下端口被占用解决方案</h2><div class="language-batch line-numbers-mode" data-ext="batch"><pre class="language-batch"><code># 查询端口
